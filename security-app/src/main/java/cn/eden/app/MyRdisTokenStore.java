...
import java.util.*;
/**
 * spring-data-redis 2.0版本中set(String,String)被弃用了，要使用RedisConnection.stringCommands().set(…)
 * conn.set(…)都换成conn..stringCommands().set(…)
 */
public class MyRdisTokenStore  implements TokenStore {
